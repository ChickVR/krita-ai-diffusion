...
search_paths: dict[str, list[str]] = {
    ...
    resource_id(ResourceKind.controlnet, SDVersion.sdxl, ControlMode.scribble): ["control-lora-sketch-rank", "controlnet-scribble-XL"],
    ...
    resource_id(ResourceKind.controlnet, SDVersion.sdxl, ControlMode.canny_edge): ["control-lora-canny-rank", "diffusion_pytorch_model_V2_canny_XL"],
    ...
    resource_id(ResourceKind.controlnet, SDVersion.sdxl, ControlMode.pose): ["control-lora-openposexl2-rank", "controlnet-openpose-sdxl-1.0"],
